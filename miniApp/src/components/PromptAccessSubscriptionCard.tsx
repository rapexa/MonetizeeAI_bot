...
interface PromptAccessSubscriptionCardProps {
  show: boolean;
  onClose: () => void;
}

const PromptAccessSubscriptionCard: React.FC<PromptAccessSubscriptionCardProps> = ({ show, onClose }) => {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-red-300 text-xs leading-relaxed mb-3">
              🔓 این پرامپت فقط در نسخه ویژه فعال است.
              <br />
              <br />
              بیش از ۲۰۰ پرامپت آماده و تخصصی برای ساخت بیزینس دلاری در نسخه کامل باز می‌شوند.
            </p>
            <button
              onClick={() => {
                onClose();
...
export default PromptAccessSubscriptionCard;
