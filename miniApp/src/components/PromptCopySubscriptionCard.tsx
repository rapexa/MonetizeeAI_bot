...
interface PromptCopySubscriptionCardProps {
  show: boolean;
  onClose: () => void;
}

const PromptCopySubscriptionCard: React.FC<PromptCopySubscriptionCardProps> = ({ show, onClose }) => {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-red-300 text-xs leading-relaxed mb-3">
              🔒 در نسخه رایگان امکان کپی پرامپت‌ها غیرفعال است.
              <br />
              <br />
              با نسخه Pro می‌تونی همه پرامپت‌ها رو کپی، شخصی‌سازی و ذخیره کنی.
            </p>
            <button
              onClick={() => {
                onClose();
...
export default PromptCopySubscriptionCard;
